...
import org.eevolution.UbiquitousLanguage.{BankAccount, Currency, DocumentType, Id, List, Partner, Payment}
import org.eevolution.api
import org.eevolution.domain.factory.PaymentBuilder
import org.eevolution.api.service.PaymentService.{PaymentServiceEnvironment, Service}
import org.eevolution.domain.valueobject.{PaymentTenderType, PaymentTrxType}
import zio.ZIO
