...
import org.eevolution.UbiquitousLanguage.{Amount, Button, Date, DateTime, Id, List, Number, Search, Table, TableDirect, YesNo}
import org.eevolution.domain.valueobject.{DocumentStatus, PaymentCreditCardType, PaymentTenderType, PaymentTrxType}
