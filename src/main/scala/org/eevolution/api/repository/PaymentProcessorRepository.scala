...
import org.eevolution.UbiquitousLanguage.PaymentProcessor
import zio.ZIO

/**
  * API Trait Payment Processor Repository
  */
trait PaymentProcessorRepository {
  def paymentProcessorRepository: PaymentProcessorRepository.Service
}

/**
  * API Singleton Object Payment Processor Repository
  */
