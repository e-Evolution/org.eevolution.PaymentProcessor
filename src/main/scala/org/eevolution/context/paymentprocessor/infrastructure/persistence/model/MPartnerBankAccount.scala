...
/**
  * Legacy Persistence Partner Bank Account Model
  *
  * @param ctx
  * @param id
  * @param rs
  * @param trxName
  */
class MPartnerBankAccount(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MBPBankAccount(ctx: Properties, id: Int, trxName: String) {
