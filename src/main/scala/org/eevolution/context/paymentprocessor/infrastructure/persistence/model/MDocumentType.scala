...
/**
  * Legacy Persistence Document Type Model
  * @param ctx
  * @param id
  * @param rs
  * @param trxName
  */
class MDocType(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MDocType(ctx: Properties, id: Int, trxName: String) {
