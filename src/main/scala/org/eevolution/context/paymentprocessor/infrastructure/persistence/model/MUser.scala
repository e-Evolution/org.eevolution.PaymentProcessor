...
/**
  ...
  * @param trxName
  */
class MUser(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MUser(ctx: Properties, id: Int, trxName: String) {
