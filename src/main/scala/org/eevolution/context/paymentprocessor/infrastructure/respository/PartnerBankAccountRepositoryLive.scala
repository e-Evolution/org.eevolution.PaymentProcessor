...
case class PartnerBankAccountRepositoryLive() extends PartnerBankAccountRepository.Service with PartnerBankAccountMapping {
  override def getById(partnerId: Id, bankId: Id, userId: Id, accountName: String, accountEmail: String, creditCardNumber: String): RIO[Any, Option[PartnerBankAccount]] =
    for {
  ...
  override def create(partnerId: Id, bankId: Id, userId: Id, accountName: String, accountEmail: String, creditCardType: String, creditCardNumber: String, creditCardExpMM: Id, creditCardExpYY: Id, creditCardVV: String): RIO[Any, Option[PartnerBankAccount]] = for {
  ...
  override def save(partnerBankAccount: PartnerBankAccount): RIO[Any, Option[PartnerBankAccount]] = for {
    newPartnerBankAccount <- RIO.fromTry {
      Try {
