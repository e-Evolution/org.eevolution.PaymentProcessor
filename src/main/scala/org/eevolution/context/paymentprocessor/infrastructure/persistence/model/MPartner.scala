...
/**
  * Legacy Persistence Business Partner Model
  * @param ctx
  * @param id
  * @param rs
  * @param trxName
  */
class MPartner(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MBPartner(ctx: Properties, id: Int, trxName: String) {
