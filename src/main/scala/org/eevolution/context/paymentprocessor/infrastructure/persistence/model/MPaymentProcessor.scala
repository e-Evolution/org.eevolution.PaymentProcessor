...
/**
  * Legacy Persistence Payment Processor Model
  *
  * @param ctx
  * @param id
  * @param rs
  * @param trxName
  */
class MPaymentProcessor(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MPaymentProcessor(ctx: Properties, id: Int, trxName: String) {
