...
/**
  * Legacy Persistence Organization Model
  * @param ctx
  * @param id
  * @param rs
  * @param trxName
  */
class MOrganization(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MOrg(ctx: Properties, id: Int, trxName: String) {
