...
import org.eevolution.context.paymentprocessor.domain.model.DocumentType
import org.eevolution.context.paymentprocessor.infrastructure.database.context._

/**
  * Document Type Mapping with Database
  */
trait DocumentTypeMapping {
  def quoteDocumentType = quote(
    querySchema[DocumentType]("C_DocType",
