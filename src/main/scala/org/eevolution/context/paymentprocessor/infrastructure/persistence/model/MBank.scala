...
/**
  ...
  * @param trxName
  */
class MBank(ctx: Properties, id: Int, rs: ResultSet, trxName: String)
  extends org.compiere.model.MBank(ctx: Properties, id: Int, trxName: String) {
