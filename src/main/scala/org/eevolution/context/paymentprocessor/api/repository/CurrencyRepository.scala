...
trait CurrencyRepository {
  def currencyRepository: CurrencyRepository.Service
}
...
object CurrencyRepository {
  ...
  trait Service {
    def getById(id: Id): ZIO[ContextEnvironment, Throwable, Currency]
  }

  trait Live extends CurrencyRepository

  object Live extends Live {
    def currencyRepository: CurrencyRepository.Service = new Service {
